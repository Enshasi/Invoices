    ...
    <div class="row ">
        <div class="col-xl-12">
            <div class="card">
                ...
                <a href="invoices/create" class="modal-effect btn btn-sm btn-primary mt-3 p-2 " style="color:white"><i
                        class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>

                    <a class="modal-effect btn btn-sm btn-primary mt-3 p-2" href="{{ url('exportInvoices') }}"
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1" data-page-length='50'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('invoices/InvoicesDetails')}}/{{$invoice->id}}">
