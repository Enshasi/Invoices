...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1 mb-2">اجمالي الفواتير</h2>
                <hp class="mg-b-0 mt-5">مرحبا بعودتك
                {{Auth::user()->name }}
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                        {{\App\Models\invoices::where('Status' , 'مدفوعة جزئيا')->sum('Total')}}
