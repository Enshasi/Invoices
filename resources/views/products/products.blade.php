...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المنتجات</span>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="d-flex justify-content-between">
                    <a class="btn ripple btn-primary    mt-3 tx-13 mr-3 mb-0 "   data-target="#modaldemo1" data-toggle="modal" href="">أضافة منتج </a>
